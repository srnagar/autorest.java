...
/**
 * The DirectorysDeleteHeaders model.
 */
@Fluent
public final class DirectorysDeleteHeaders {
    /*
     ...
     * @return the DirectorysDeleteHeaders object itself.
     */
    public DirectorysDeleteHeaders setXMsVersion(String xMsVersion) {
     ...
     * @return the DirectorysDeleteHeaders object itself.
     */
    public DirectorysDeleteHeaders setXMsContinuation(String xMsContinuation) {
     ...
     * @return the DirectorysDeleteHeaders object itself.
     */
    public DirectorysDeleteHeaders setXMsRequestId(String xMsRequestId) {
     ...
     * @return the DirectorysDeleteHeaders object itself.
     */
    public DirectorysDeleteHeaders setXMsClientRequestId(String xMsClientRequestId) {
     ...
     * @return the DirectorysDeleteHeaders object itself.
     */
    public DirectorysDeleteHeaders setDateProperty(OffsetDateTime dateProperty) {
