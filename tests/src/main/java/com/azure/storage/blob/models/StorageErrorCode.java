...
public final class StorageErrorCode extends ExpandableStringEnum<StorageErrorCode> {
    ...
    /**
     * Static value NoAuthenticationInformation for StorageErrorCode.
     */
    public static final StorageErrorCode NO_AUTHENTICATION_INFORMATION = fromString("NoAuthenticationInformation");
