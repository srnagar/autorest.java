...
public final class BlockBlobsCommitBlockListResponse extends ResponseBase<BlockBlobsCommitBlockListHeaders, Void> {
     ...
     */
    public BlockBlobsCommitBlockListResponse(HttpRequest request, int statusCode, HttpHeaders rawHeaders, Void value, BlockBlobsCommitBlockListHeaders headers) {
